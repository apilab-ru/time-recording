...
import { InputMaskElement, InputmaskMaskFormat, InputmaskPipe, InputmaskPreset, MaskConfig } from 'angular5-input-mask';
...
export class InputMaskDirective implements ControlValueAccessor, OnChanges {
  ...
  constructor(
    ...
    this.renderer = rendererFactory.createRenderer(element, null);
  }
